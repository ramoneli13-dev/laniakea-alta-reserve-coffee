...
export function Hero() {
  return (
    <section id="home" className="relative min-h-screen overflow-hidden pt-24">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-coffee-black/58 via-coffee-black/18 to-coffee-black/8" />
      <div className="absolute inset-x-0 bottom-0 h-1/4 bg-gradient-to-t from-coffee-black to-transparent" />
